            ...
            .then(() =>
                this.setState({
                    subscriptions: this.state.subscriptions.filter(
                        (subscription) =>
                            subscription.url !==
                            this.state.subscriptions[index].url
                    ),
                })
            )
            .catch((err) => console.log(err));
                    ...
                    <Modal.Body>
                        <Form>
                            <Form.Group as={Row}>
                                ...
                                <Col xs={10}>
                                    <Form.Control
                                        ...
                                        onChange={this.onNewCardUrlChange.bind(
                                            this
                                        )}
                                    />
                                </Col>
                            ...
                            <Form.Group as={Row}>
                                ...
                                <Col xs={10}>
                                    <Rate
                                        onChange={this.onNewCardRateChange.bind(
                                            this
                                        )}
                                        defaultValue={0}
                                    />
